...
class QuizAPI {
    ...
    suspend fun getAllQuestions(): Quiz {
        try {
            return httpClient.get("https://quiz.leod1.fr/quizz").body()
        }
        catch (e: Exception) {
            return Quiz(questions = listOf(
                Question(
                    1,
                ...
                Question(
                    ...
                    2,
                    listOf(Answer(1, "Coroutines"), Answer(2, "ViewModels"), Answer(3, "Returns"), Answer(4, "Managed threads"))
                ),
                Question(
                    3,
                    "What is the name of the Gradle plugin that enables you to write Kotlin code for your Gradle build files?",
                    3,
                    listOf(Answer(1, "Kotlin Gradle plugin"), Answer(2, "Kotlin DSL plugin"), Answer(3, "Kotlin build plugin"), Answer(4, "Kotlin build tools plugin"))
                ),
                Question(
                    4,
                    "You can create an emulator to simulate the configuration of a particular type of Android device using a tool like",
                    3,
                    listOf(Answer(1, "Theme Editor"), Answer(2, "Android SDK Manager"), Answer(3, "AVD Manager"), Answer(4, "Virtual Editor"))
                ),
                Question(
                    5,
                    "What parameter specifies the Android API level that Gradle should use to compile your app?",
                    2,
                    listOf(Answer(1, "minSdkVersion"), Answer(2, "Android SDK Manager"), Answer(3, "AVD Manager"), Answer(4, "Virtual Editor"))
                ),
            ))
        }
    }
